...
// The delay parameter is in units of the core clock. (units of 38.4615 nsec for 26 MHz clock)
// Example: SysTick_Wait(1000);  // wait 1000 clock cycles (38.4615 us)
...
void SysTick_Wait10ms(uint32_t delay){
  uint32_t i;
  for(i=0; i<delay; i++){
    SysTick_Wait(260000);  // wait 10ms (26 MHz clock)
  }
}
...
void SysTick_Wait10us(uint32_t delay){
  uint32_t i;
  for(i=0; i<delay; i++){
    SysTick_Wait(260);  // wait 10us (26 MHz clock)
  }
}
